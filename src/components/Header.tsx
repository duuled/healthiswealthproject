      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <a
              href="https://www.linkedin.com/in/keaton-tyler-8b3b10b7"
              target="_blank"
              rel="noopener noreferrer"
              className={`transition-colors duration-200 ${isScrolled ? 'text-foreground' : 'text-white'} hover:opacity-60`}
              aria-label="LinkedIn Keaton Tyler"
            >
              <Linkedin className="w-4 h-4" />
            </a>
            <a
              href="https://x.com/ktylermotion"
              target="_blank"
              rel="noopener noreferrer"
              className={`transition-colors duration-200 ${isScrolled ? 'text-foreground' : 'text-white'} hover:opacity-60`}
              aria-label="X @ktylermotion"
            >
          ...
          <div className="lg:hidden bg-background/98 backdrop-blur-lg border-t border-border/50 -mx-6 px-6">
            <div className="py-6 space-y-1">
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-border/50">
                ...
                <a href="https://www.linkedin.com/in/keaton-tyler-8b3b10b7" target="_blank" rel="noopener noreferrer" className="text-foreground hover:opacity-60" aria-label="LinkedIn Keaton Tyler">
                  <Linkedin className="w-5 h-5" />
                </a>
                <a href="https://x.com/ktylermotion" target="_blank" rel="noopener noreferrer" className="text-foreground hover:opacity-60" aria-label="X @ktylermotion">
